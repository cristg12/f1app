      ...
      <div className="rounded-sm border-2 border-black flex flex-row mt-12 mr-12 ml-12 bg-[#13242b] gradient-background">
        <div className="w-1/3 flex-column">
          ...
          <div className="font-medium h-1/3">
            ...
            <p id="lapNumber" className="text-white pl-11 xl:text-4xl lg:text-2xl md:text-2xl sm:text-sm">
              1:31.447
            </p>
            <p className="text-white pl-11 mt-4 xl:text-4xl lg:text-2xl md:text-2xl sm:text-sm">
        ...
        <div id="smallCircle" className="flex items-center justify-center xl:w-14 xl:h-14 lg:w-12 lg:h-12 md:w-10 md:h-10 sm:w-10 sm:h-8 border-3 border-white rounded-full">
              <p id="number" className="xl:text-2xl lg:text-2xl md:text-2xl sm:text-sm block rounded-full px-2 py-2 text-xs text-white 	">3</p>
            </div>
            <p id="hiddenText" className="text-white text-center justify-center sm:hidden">Max. Speed</p>
          </div>

          <div  className=" flex flex-col items-center justify-center ">
          <div id="smallCircle" className="flex items-center justify-center w-14 h-14 border-3 border-white rounded-full">
              <p id="number" className="xl:text-2xl lg:text-2xl md:text-2xl sm:text-sm block rounded-full px-2 py-2 text-xs text-white 	">3</p>
            </div>
            <p id="hiddenText" className="text-white text-center justify-center ">DRS Zone</p>
          </div>

        </div>
          
        <div className="font-medium ml-auto w-8/12">
